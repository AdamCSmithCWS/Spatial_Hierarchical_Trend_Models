...
## details in Smith et al. 2023
seasons <- read.csv("data/Shorebird_seasons_by_species.csv")
...
FYYYY = 1980 #first year that shorebird monitoring data were modeled
...
# Red Knot (and many other species modeled in Smith et al. 2023)
...
# 
  ...
  stanfit$save_object(paste0("output/fit_Shorebird_spatial_GAMYE.rds"))
  saveRDS(stan_data,paste0("output/datalist_Shorebird_spatial_GAMYE.rds"))
